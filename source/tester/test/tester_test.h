...
//     take the opportunity to explore the differences between glibc and BSD libc.
    ...
    #define WEAK_DECL(type, name, args) type name args __attribute__((weak))
#elif OS_MAC
    #include <string.h>
    #define WEAK_DECL(type, name, args) type name args __attribute__((weak_import))
#endif
...
WEAK_DECL(int, ft_isalpha, (int c));
WEAK_DECL(int, ft_isdigit, (int c));
WEAK_DECL(int, ft_isalnum, (int c));
WEAK_DECL(int, ft_isascii, (int c));
WEAK_DECL(int, ft_isprint, (int c));
WEAK_DECL(size_t, ft_strlen, (const char *s));
WEAK_DECL(void *, ft_memset, (void *s, int c, size_t n));
WEAK_DECL(void, ft_bzero, (void *s, size_t n));
WEAK_DECL(void *, ft_memcpy, (void *dest, const void *src, size_t n));
WEAK_DECL(void *, ft_memmove, (void *dest, const void *src, size_t n));
WEAK_DECL(size_t, ft_strlcpy, (char *dst, const char *src, size_t size));
WEAK_DECL(size_t, ft_strlcat, (char *dst, const char *src, size_t size));
WEAK_DECL(int, ft_toupper, (int c));
WEAK_DECL(int, ft_tolower, (int c));
WEAK_DECL(char *, ft_strchr, (const char *s, int c));
WEAK_DECL(int, ft_strncmp, (const char *s1, const char *s2, size_t n));
WEAK_DECL(void *, ft_memchr, (const void *s, int c, size_t n));
WEAK_DECL(int, ft_memcmp, (const void *s1, const void *s2, size_t n));
WEAK_DECL(char *, ft_strnstr, (const char *haystack, const char *needle, size_t n));
WEAK_DECL(int, ft_atoi, (const char *s));
WEAK_DECL(void *, ft_calloc, (size_t num, size_t size));
WEAK_DECL(char *, ft_strdup, (const char *s));

// Part 2 - Additional functions
WEAK_DECL(char *, ft_substr, (char const *s, unsigned int start, size_t len));
WEAK_DECL(char *, ft_strjoin, (char const *s1, char const *s2));
WEAK_DECL(char *, ft_strtrim, (char const *s1, char const *set));
WEAK_DECL(char **, ft_split, (char const *s, char c));
WEAK_DECL(char *, ft_itoa, (int num));
WEAK_DECL(char *, ft_strmapi, (char const *s, char (*f)(unsigned int, char)));
WEAK_DECL(void, ft_striteri, (char *s, void (*f)(unsigned int, char *)));
WEAK_DECL(void, ft_putchar_fd, (char c, int fd));
WEAK_DECL(void, ft_putstr_fd, (char *s, int fd));
WEAK_DECL(void, ft_putendl_fd, (char *s, int fd));
WEAK_DECL(void, ft_putnbr_fd, (int n, int fd));
...
WEAK_DECL(t_list *, ft_lstnew, (void *content));
WEAK_DECL(void, ft_lstadd_front, (t_list **lst, t_list *newlst));
WEAK_DECL(int, ft_lstsize, (t_list *lst));
WEAK_DECL(t_list *, ft_lstlast, (t_list *lst));
WEAK_DECL(void, ft_lstadd_back, (t_list **lst, t_list *newlst));
WEAK_DECL(void, ft_lstdelone, (t_list *lst, void (*del)(void *)));
WEAK_DECL(void, ft_lstclear, (t_list **lst, void (*del)(void *)));
WEAK_DECL(void, ft_lstiter, (t_list *lst, void (*f)(void *)));
WEAK_DECL(t_list *, ft_lstmap, (t_list *lst, void *(*f)(void *), void (*del)(void *)));
