...
internal TestPayload callback_for_isdigit(TestParameters test_parameters);
...
internal TestPayload callback_for_isascii(TestParameters test_parameters);
...
internal TestPayload callback_for_atoi(TestParameters test_parameters);
internal TestPayload callback_for_itoa(TestParameters test_parameters);
...
internal TestPayload callback_for_split(TestParameters test_parameters);
...
internal TestPayload callback_for_strtrim(TestParameters test_parameters);
...
internal TestPayload callback_for_strlcat(TestParameters test_parameters);
internal TestPayload callback_for_strchr(TestParameters test_parameters);
internal TestPayload callback_for_strncmp(TestParameters test_parameters);
internal TestPayload callback_for_strnstr(TestParameters test_parameters);
internal TestPayload callback_for_calloc(TestParameters test_parameters);
internal TestPayload callback_for_substr(TestParameters test_parameters);
...
internal TestPayload callback_for_putstr_fd(TestParameters test_parameters);
internal TestPayload callback_for_putendl_fd(TestParameters test_parameters);
internal TestPayload callback_for_putchar_fd(TestParameters test_parameters);
internal TestPayload callback_for_putnbr_fd(TestParameters test_parameters);
internal TestPayload callback_for_lstnew(TestParameters test_parameters);
internal TestPayload callback_for_lstadd_front(TestParameters test_parameters);
internal TestPayload callback_for_lstsize(TestParameters test_parameters);
